...
$SNP_THEMES_theme15_SIZES = array();
for ($i = 10; $i <= 72; $i++)
{
    $SNP_THEMES_theme15_SIZES[$i]	 = $i . 'px';
}
$SNP_THEMES['theme15']		 = array(
    'NAME'	 => 'Theme 15  [Themes Pack]',
    'STYLES' => 'css/theme15.css',
    'TYPES'	 => array(
	...
	array(
	    ...
	    'desc'	 => __('px (default: 550)', 'nhp-opts'),
	    'class'	 => 'mini',
	    'std'	 => '550'
	),
	array(
	...
	array(
	    ...
	    'args'	 => array(
		'sizes'		 => $SNP_THEMES_theme15_SIZES,
		'disable_fonts'	 => 1,
		'disable_color'	 => 1,
	    ),
	...
	array(
	    ...
	    'type'	 => 'color',
	    'std'	 => '#FF0A5A',
	    'desc'	 => __('(default: #FF0A5A)', 'nhp-opts'),
