...
//function	
	...
	function _custom_fields_html($post, $metabox)
	{
		...
		echo '</table>';
		echo '</div>';
		if ($field['type'] == 'select_theme')
		{
		    echo '<div style="text-align: center;" class="snp-nhp-opts-select-theme-preview"><img id="nhp-opts-select-theme-preview-img" style="display: none;"/></div>';
		}
	    }
	}
