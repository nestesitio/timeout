...
class SNP_NHP_Options_egoi_lists extends SNP_NHP_Options
{
...
//function
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_egoi_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button egoi_lists_gl" name="" value="Grab Lists" />';
		}
...
//function
	...
	function enqueue()
	{
		...
		wp_enqueue_script(
				'nhp-opts-field-egoi_lists-js', SNP_NHP_OPTIONS_URL . 'fields/egoi_lists/field_egoi_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
