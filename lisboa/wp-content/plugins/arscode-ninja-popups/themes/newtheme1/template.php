...
{
	echo '.snp-pop-'.$ID.' .snp-newtheme1 h2 {font-size: '.$POPUP_META['snp_header_font']['size'].'px; color: '.$POPUP_META['snp_header_font']['color'].';}'."\n";
}
if (!empty($POPUP_META['snp_subheader_font']['size']))
{
	...
	echo '.snp-pop-'.$ID.' .snp-newtheme1 .snp-newsletter-content p {color: '.$POPUP_META['snp_subheader_font']['color'].';}'."\n";
}
...
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme1 .snp-submit { background-color: '.$POPUP_META['snp_submit_button_color'].';}'."\n";
	echo '.snp-pop-'.$ID.' .snp-newtheme1 .snp-newsletter-content h2:before { background-color: '.$POPUP_META['snp_submit_button_color'].';}'."\n";
	echo '.snp-pop-'.$ID.' .snp-newtheme1 form input[type="text"],.snp-pop-'.$ID.' .snp-newtheme1 form select,.snp-pop-'.$ID.' .snp-newtheme1 form textarea,.snp-pop-'.$ID.' .snp-newtheme1 form input[type="text"]:focus,.snp-pop-'.$ID.' .snp-newtheme1 form select:focus,.snp-pop-'.$ID.' .snp-newtheme1 form textarea:focus {border: 1px solid '.$POPUP_META['snp_submit_button_color'].';}';
}
if (!empty($POPUP_META['snp_submit_button_hover_color']))
{
    	echo '.snp-pop-'.$ID.' .snp-newtheme1 form input[type="submit"]:hover { background-color: '.$POPUP_META['snp_submit_button_hover_color'].';}'."\n";
}
