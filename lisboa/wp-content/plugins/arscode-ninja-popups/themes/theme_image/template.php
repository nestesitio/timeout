<div class="snp-fb snp-theme-image">
	<div class="snp-content">
		<div class="snp-content-inner">
			...
			{
				echo '<img src="'.$POPUP_META['snp_image'].'" alt="" />'; 
			}
...
if ($POPUP_META['snp_bg_gradient'])
{
	...
	?>
		...
		.snp-pop-<?php echo $ID; ?> .snp-theme-image .snp-powered {
		  ...
		  <?php if ($POPUP_META['snp_closetext_color']) {echo 'color: '.$POPUP_META['snp_closetext_color'].';';}?>
		}
	<?php
}
...
{
	echo '.snp-pop-'.$ID.' .snp-theme-image .snp-no-thx, .snp-pop-'.$ID.' .snp-theme-image .snp-powered , .snp-pop-'.$ID.' .snp-theme-image .snp-privacy { color: '.$POPUP_META['snp_closetext_color'].';}';
}
echo '</style>';
?>