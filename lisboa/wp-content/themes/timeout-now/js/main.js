$(function() {
    ...
    var tmh = {
        ...
        changeSlider: function() {
            ...
            tmh.vars.time = setTimeout(function() {
                tmh.vars.control++;
                if(tmh.vars.control >= tmh.el.main.find('.home-slideshow__slider').size()) tmh.vars.control = 0;
        ...
        init: function() {
            ...
            tmh.el.main.find('.home-slideshow').swipe({
                ...
                swipeRight: function(event, direction, distance, duration, fingerCount) {
                    tmh.vars.control--;
                    if(tmh.vars.control < 0) tmh.vars.control = tmh.el.main.find('.home-slideshow__slider').size() - 1;
                    tmh.changeSlider();
                },
    ...
    if($('body').hasClass('home')) tmh.init();
    if($('body').hasClass('page-id-533') || $('body').hasClass('page-id-539')) tmc.init();
    if($('body').hasClass('post-type-archive-comer-e-beber')) tmaet.init();
    if($('body').hasClass('page-template-concept')) tmconcept.init();
    ...
    $('header .menu-main-pt-container').css("height", $(window).height());
         ...
         if ($(".sampleClass").css("float") == "none" ){
            ...
            $(".home-module__col .home-module__image-wrapper .home-module__image").css({'height':($(".add-1").outerHeight() + $(".add-2").outerHeight()+ $(".add-3").outerHeight() + 'px')});
