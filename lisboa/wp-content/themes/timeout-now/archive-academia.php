		...
		if ( have_posts() ) : ?>
			...
			<header class="page-header academy-studio-archive">
				...
				<div style="float:right;" class="col col--two col--padding ">
					...
					<br />
					<p class="studio-info">Tickets and information:</p>
					<p class="studio-info">Time Out Level 0 Mercado da Ribeira | <a href="mailto:Academia@timeoutmarket.com">Academia@timeoutmarket.com</a> | 213470391</p> 
				...
				<br />
					...
					<p class="studio-info">Espaço Time Out Piso 0 Mercado da Ribeira | <a href="mailto:Academia@timeoutmarket.com">Academia@timeoutmarket.com</a> | 213470391</p>

					<?php endif; ?>
					<br />
					<ul class="site-footer__social-list">
						<li class="site-footer__social-list-item">
							<a class="site-footer__social-list-link" href="https://www.facebook.com/AcademiaTimeOut/" target="_blank">
								<div class="icon icon-facebook"></div>
							</a>
						</li>
						<li class="site-footer__social-list-item">
							<a class="site-footer__social-list-link" href="https://www.instagram.com/academiatimeout/" target="_blank">
