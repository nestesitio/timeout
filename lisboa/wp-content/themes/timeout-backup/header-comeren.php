...
<script src="<?php echo get_template_directory_uri(); ?>/js/createjs-2015.11.26.min.js"></script>
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/TimeOut_PlantaAnimate_ENG.js"></script>
        <script>
...
function handleComplete(evt) {
  ...
  (function(isResp, respDim, isScale, scaleType) {    
    ...
    function resizeCanvas() {     
      ...
      canvas.style.width = preloaderDiv.style.width = '87%';      
      canvas.style.height = preloaderDiv.style.height = 'auto';
