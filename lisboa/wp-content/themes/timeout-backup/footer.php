...
?>
<?php
$footer_post = get_page_by_path('footer');
?>
            ...
            <div class="col col--two footer-1">
                ...
                <section class="col col--two col--two--mobile col--padding-left-big">
                    ...
                    <a class="address-link" target="_blank" href="https://www.google.pt/maps/place/Time+Out+Mercado+da+Ribeira/@38.7067345,-9.1481336,17z/data=!3m1!4b1!4m5!3m4!1s0xd193487595e6075:0x138fe14e4972dc92!8m2!3d38.7067345!4d-9.1459449"><h2 class="site-footer__subtitle">Address</h2>
                        <address class="site-footer__copy"><?php echo nl2br(get_field('address', $footer_post->ID)); ?></address></a>
                    ...
                    <p class="site-footer__copy"><a href="tel:<?php echo get_field('tel', $footer_post->ID); ?>"><?php echo get_field('tel', $footer_post->ID); ?></a></p>
                    <h2 class="site-footer__subtitle">E-Mail</h2>
                    <p class="site-footer__copy"><a href="mailto:<?php echo get_field('email', $footer_post->ID); ?>"><?php echo get_field('email', $footer_post->ID); ?></a></p>
    ...
    pid: 14599
        ...
        <script type="text/javascript">
            (function () {
                ...
                ev.async = true;
                ev.setAttribute('data-ev-tag-pid', 14599);
                ev.setAttribute('data-ev-tag-ocid', 2211);
        ...
        <script type="text/javascript">
            (function () {
                ...
                hn.async = true;
                hn.setAttribute('data-ev-hover-pid', 14599);
                hn.setAttribute('data-ev-hover-ocid', 2211);
...
<?php else: ?>
    ...
    <?php wp_nav_menu(array('theme_location' => 'primary', 'menu_id' => 'primary-menu', 'container' => 'div', 'container_class' => 'menu-lang')); ?>
            ...
            <section class="col col--two col--two--mobile col--padding-left-big">
                ...
                <?php $links = ['facebook', 'instagram', 'youtube'];?>
                <ul class="site-footer__social-list">
                    <?php foreach ($links as $link): 
                        if(!empty(get_field('link-' . $link, $footer_post->ID))): ?>
                    <li class="site-footer__social-list-item">
                        <a class="site-footer__social-list-link" href="<?php echo get_field('link-' . $link, $footer_post->ID)?>" target="_blank">
                            <div class="icon icon-<?php echo $link?>"></div>
                        </a>
                    </li>
                     <?php endif; 
                     endforeach; ?>
    ...
    <div class="subheader">
        <ul style="margin:0 auto;padding:0">
            <li style="font-size:9px;"><?php echo nl2br(get_field('copy', $footer_post->ID)); ?></li>
    ...
    <script type="text/javascript">
        (function () {
            var ev = document.createElement('script'); ev.type = 'text/javascript'; ev.async = true; ev.setAttribute('data-ev-tag-pid', 14597);
            ev.setAttribute('data-ev-tag-ocid', 2211);
            ev.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'c.betrad.com/pub/tag.js';
            var s = document.getElementsByTagName('script')[0];
            s.parentNode.insertBefore(ev, s);
    ...
    <script type="text/javascript">
        (function () {
            ...
            hn.async = true;
            hn.setAttribute('data-ev-hover-pid', 14597); hn.setAttribute('data-ev-hover-ocid', 2211);
            hn.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'c.betrad.com/geo/h1.js';
            var s = document.getElementsByTagName('script')[0];
            s.parentNode.insertBefore(hn, s);
        })();
